import { reconciler, MarkdownNode, _renderCompleted, lastRootNode, TextNode } from "./reconciler.js";
...
export function renderToMd(element: React.ReactElement): string {
  ...
  const root = reconciler.createContainer(container, 0, null, false, false, '', console.error, null);
